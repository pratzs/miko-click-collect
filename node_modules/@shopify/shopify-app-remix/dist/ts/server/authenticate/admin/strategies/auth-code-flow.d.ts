...
export declare class AuthCodeFlowStrategy<Config extends AppConfigArg> implements AuthorizationStrategy {
    protected api: Shopify<ApiConfigWithFutureFlags<Config['future']>, ApiFutureFlags<Config['future']>>;
