...
:root{
 ...
 --lime:#A3E635;--muted:#6E7C5C;--line:#DEEAC7;--card:#fff;--ok:#65A30D}
...
.spectrum{position:absolute;top:0;left:0;right:0;height:6px;background:linear-gradient(90deg,#D9F99D,#A3E635,#65A30D,#3F6212)}
...
.pill.on{background:rgba(101,163,13,.14);color:#3F6212}
...
.st.c{background:rgba(163,230,53,.18);color:#3F6212}
.st.p{background:rgba(132,204,22,.24);color:#365314}
.st.k{background:rgba(101,163,13,.26);color:#2B4109}
.st.r{background:#65A30D;color:#fff}
.st.d{background:rgba(110,124,92,.14);color:#5B6B4A}
/* status stepper */
